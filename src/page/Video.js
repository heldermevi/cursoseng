...
const Video = () => {
  ...
  return ( 
    ...
    <View>
      <Text style={styles.text3}>Grave Um Vídeo</Text>
      <Image source={require('./assets/cam.svg')} resizeMode = 'center' style={styles.image}>
            </Image > 
      ...
      <View>
      <TouchableOpacity style={styles.button3}  onPress={() => Alert.alert(  )}>     
           <Text style={styles.text4}>Gravar Vídeo</Text>
           <Image source={require('./assets/cam.svg')} resizeMode = 'center' style={styles.image3}>
            </Image > 
      </TouchableOpacity>        
      </View>  
       </View>

       <Image source={require('./assets/hom.svg')} resizeMode = 'center' 
              style={styles.image2}>
      </Image > 
      <View> 
